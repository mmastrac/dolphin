...
struct OpArg
{
	...
	OpArg AsImm(u8 asScale)
	{
		switch (asScale)
		{
		case 8: return AsImm8();
		case 16: return AsImm16();
		case 32: return AsImm32();
		case 64: return AsImm64();
		default: _assert_msg_(DYNA_REC, 0, "AsImm: invalid scale %d", asScale); return *this;
		}
	}
	...
	OpArg SwapImm() const
	{
		switch (scale)
		{
		case SCALE_IMM8: return *this;
		case SCALE_IMM16: return OpArg(Common::swap16((u16)offset), SCALE_IMM16);
		case SCALE_IMM32: return OpArg(Common::swap32((u32)offset), SCALE_IMM32);
		case SCALE_IMM64: return OpArg(Common::swap64((u64)offset), SCALE_IMM64);
		default: _assert_msg_(DYNA_REC, 0, "SwapImm: invalid scale %d", scale); return *this;
		}
	}
