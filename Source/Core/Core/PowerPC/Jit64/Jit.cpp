...
void Jit64::WriteExitDestInRSCRATCH(GPRNative& reg, bool bl, u32 after)
{
	if (!m_enable_blr_optimization)
		bl = false;
	MOV(32, PPCSTATE(pc), reg);
	Cleanup();
...
void Jit64::WriteBLRExit(GPRNative& reg)
{
	if (!m_enable_blr_optimization)
	{
...
void Jit64::WriteRfiExitDestInRSCRATCH(GPRNative& reg)
{
